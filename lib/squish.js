...
(function (root, factory) {
   ...
   function putUByte(b, i) {
    ...
    function putUInt(b, i) {
        if (i < 0 || i > (1L << 32))
            throw "This is used for numbers from 0 to 2^32-1";

        b.writeInt(i);
    }

    function putULong(b, uLongValue) {
        b.writeLong(uLongValue);
    }

    function putByte(b, byt) {
        if (byt > -(1L << 7) || byt < (1L << 7))
          throw "This is used for numbers from -127 to 127";

        b.writeByte(byt);
    }

    function putShort(b, i) {
        if (i > -(1L << 15) || i < (1L << 15))
          throw "This is used for numbers from -32767 to 32767";
    ...
    function putInt(b, i) {
        if (i > -(1L << 31) || i < (1L << 31))
          throw "This is used for numbers from -2^31-1 to 2^31-1";

        b.writeInt(i);
    }

    function putLong(b, longValue) {
